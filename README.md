# ProjetoOngAniProjeto desenvolvido durante o estágio na empresa 5by5 com o objetivo de praticar a utilização do Framework Dapper, funções lambda e também a aplicação aplicação do MVC.
